...
{
    // TODO:
    // если пользовательне выберет файл обработать ситуацию!
    ...
    // TODO: наверное эти параметры не должны меняться в течении одной сессии, может сделать их членами класса
